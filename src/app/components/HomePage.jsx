  ...
  return (
       <div className='bg-[#F1F1F4]'>
        <div className="h-screen flex flex-col md:flex:row">
          <h1 className='md:absolute md:pl-[42px] pl-3 pt-[20px] text-[34px] font-semibold'>Home</h1>
          <div className="flex flex-col mt-3 md:flex-row w-[98%] m-auto md:w-[900px] h-[550px] bg-white rounded-3xl md:m-auto items-center justify-evenly">
            ...
            <div className="flex w-[95%] md:flex-col mt-[4%] md:mt-0 md:justify-center md:items-center md:w-[350px] h-[450px] bg-[#D9D9D957] md:mr-4 rounded-2xl md:rounded-2xl rounded-b-none items-center justify-center md:mb-0">
              ...
              <p className='text-[18px] md:text-[20px] font-medium'>Welcome,</p>
              ...
              <button onClick={() => {signOut()}} className='mt-[10px] text-[18px] md:text-[20px] bg-red-400 rounded-xl w-full md:w-[110px] h-[40px] items-center justify-center font-semibold'>
                Logout
              </button>
              </div>
            </div>
            ...
            <div className="flex flex-col w-[95%] md:w-[450px] h-[450px] mb-4 md:mb-0 bg-[#D9D9D957] rounded-2xl md:rounded-2xl rounded-t-none  items-center justify-center">
              ...
              <p className='w-[240px] text-[22px] md:text-[26px] m-auto mt-[-20px] font-semibold text-left md:text-center'>Join or Create a lobby</p>
              <input placeholder="Enter lobby code" onChange={(e) => {setLobbyCode(e.target.value)}} className='border-[2px] text-[18px] md:text-[22px] font-medium mt-[20px] bg-[#f3f3f3] border-[#757575] duration-[300ms] outline-none rounded-[18px] w-[300px] md:w-full h-[50px] pl-[20px] pr-[20px]'/>
              <div className='flex items-center justify-center mt-3 md:mt-[30px] gap-[5px]'>
              <button  className='bg-blue-200 rounded-2xl w-[90px] md:w-[190px] h-[50px] text-[20px] md:text-[22px] items-center justify-center font-semibold'>
                Join
              </button>
              <button className='bg-blue-200 rounded-2xl w-[90px] md:w-[190px] h-[50px] text-[20px] md:text-[22px] items-center justify-center font-semibold'>
                Create
